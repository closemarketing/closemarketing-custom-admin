...
= 0.5.2 =
*   Added WP Sync DB from  Cory Simmons (PHP7 ready)

= 0.5.1 =
*   Added WP Sync DB Files
...
= 0.2.2 =
*   Added admin bar colour in local.

= 0.2.1 =
*   Added admin bar colour.

= 0.2 =
*   Added resize images and clean url seo.
